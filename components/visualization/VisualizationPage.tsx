...
import ClusterChart from "./cluster/cluster-chart";
import ClusterLegend from "./cluster/cluster-legend";
import MobileSankeyDiagram from "./cluster/mobile-sankey-diagram";
  ...
  return (
    <PageShell>
      ...
      <div className="flex flex-col md:flex-row gap-1.5">
        <ClusterChart engagementScore={engagementScore} clusterDots={clusterDots} />
        <ClusterLegend segments={segments} />
      </div>
