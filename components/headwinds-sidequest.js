    ...
    >
      <Column>
        ...
        <Paragraph customStyle={paraStyle}>
          ...
          new company! Whether you need a mix of Full-stack or 100% Frontend, I
          can help you and your team build web applications as both mentor and
          lead contributor. Learn more about me on my{" "}
          <Link url="https://www.linkedin.com/in/brandonflowers">Linkedin</Link>{" "}
          and <Link url="https://github.com/headwinds/">Github</Link>.
        </Paragraph>
        <Paragraph customStyle={paraStyle}>
          I 💛 solving complex customer journeys, workflows, and crafting
          executive dashboards rich with metrics and data visualisations.
        </Paragraph>
        <SubHeadline
          color={gold}
          customStyle={{
        ...
        >
          As a passionate, product-focussed dev, I also prototype and write about React, APIs,
